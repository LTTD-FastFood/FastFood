...
public class Profile extends AppCompatActivity {
    ...
    Button btnSignOut;
    EditText name,birth,phone,mail,password;
    SharedPreferences sharedPreferences;
    SessionManager sessionManager;
    String getId;
    Menu action;
    String url = "http://192.168.1.8/Android/read_detail.php";
    String url_edit = "http://192.168.1.8/Android/edit_detail.php";
    String url_Upload = "http://192.168.1.8/Android/upload.php";
    Bitmap bitmap;
...
//                sessionManager.Logout();
    ...
    private void SaveEditDetail() {
        ...
        final String passwrod = this.password.getText().toString().trim();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                ...
                                sessionManager.createSession(name,email,passwrod,phone,birth,id);
                            }
